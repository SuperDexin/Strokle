...
const orders = [
	...
	["8", "8", "4", "5", "3"], ["8", "8", "8", "8", "1"], ["3", "2", "3", "c", "4"], ["1", "5", "2", "8", "8"], ["1", "2", "1", "1", "2"],
	["4", "4", "1", "5", "8"], ["4", "4", "1", "3", "6"], ["4", "4", "1", "5", "1"], ["4", "6", "5", "3", "4"], ["1", "1", "2", "c", "2"]];


const total_char = 205;
const stroke_num = 5;
...
function refresh(){
	...
	is_end = false;
	all_result = [];
	document.getElementById("head").innerHTML = "STROKLE<span style=\"font-size:3rem\">5</span>";
...
function show_answer() {
	...
	let button_content;
	if (!answer_hidden) {
		content = "STROKLE<span style=\"font-size:3rem\">5</span>";
		button_content = "查看答案";
	}
	if (answer_hidden) {
